...
def openphoto():
    ...
    fileName = askopenfilename(initialdir='C:/Users\dell\Desktop\PlantDiseaseDetection-master\testpicture', title='Select image for analysis ', filetypes=[('image files', '.jpg')])
    dst = "C:/Users/dell/Desktop/PlantDiseaseDetection/testpicture"
